...
--
-- WHAT THIS IS
--   Migrations 005 and 006 concatenated, in order, so the whole analytics layer
--   can be applied in a single paste.
--
-- HOW TO RUN
...
--   select * from rpc_overview(30);                -- should return a JSON object
-- ============================================================================
